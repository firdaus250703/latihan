        ...
        <div id="auth-left">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    <input id="name" name="name" type="text" class="form-control form-control-xl" :value="old('name')" required autofocus autocomplete="name" placeholder="Name">
                    <div class="form-control-icon">
                        <i class="bi bi-person"></i>
                    </div>
                </div>
                <div class="form-group position-relative has-icon-left mb-4">
                    <input id="email" type="email" name="email" class="form-control form-control-xl" :value="old('email')" required autocomplete="username" placeholder="Email">
                    <div class="form-control-icon">
