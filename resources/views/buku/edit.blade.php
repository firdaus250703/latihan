...
<div class="page-heading">
    <div class="page-title">
        <div class="row">
            ...
            <div class="col-md-2">
                <a href="{{route ('buku.index')}}"><button type="button" class="btn btn-warning"><i class="fa-solid fa-circle-arrow-left" style="color: #000000;"></i> Kembali</button></a>
                                        ...
                                        <form action="{{ route('buku.update', $data['id']) }}" enctype="multipart/form-data" method="POST">
                                            ...
                                            <div class="row">
                                              <div class="col-md-6">
                                                ...
                                                <input type="text" name="judul" value="{{ $data ['judul']}}" class="form-control @error('judul') is-invalid @enderror" id="basicInput" placeholder="Masukkan nama kategori">
                                                @error('judul')
                                              ...
                                              <div class="col-md-6">
                                                ...
                                                <input type="text" name="penulis" value="{{ $data ['penulis']}}" class="form-control @error('penulis') is-invalid @enderror" id="basicInput" placeholder="Masukkan nama kategori">
                                                @error('penulis')
                                                <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                              </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select name="kategori" class="form-select" aria-label="Default select example">
                                                        ...
                                                        @foreach ($kategori as $item)
                                                           <option @selected($item->id == $data->kategori_id) value="{{ $item->id }}">{{ $item['kategori']}}</option> 
                                                        @endforeach
                                                      </select>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="formFile" class="form-label mt-2">Sampul Buku <small>Max.500 Kb </small>
                                                        ...
                                                        <br>
                                                        <img src="{{asset('upload/'.$data['sampul'])}}" alt="" class="w-25 img-fluid">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="deskripsi"  class="form-control" id="exampleFormControlTextarea1" rows="3">{{ old('deskripsi', $data->deskripsi) }}</textarea>
                                                      </div>
                                                </div>
                                            </div>
