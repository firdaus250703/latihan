                                        ...
                                        <form action="{{ route('buku.store') }}" enctype="multipart/form-data" method="POST">
                                            ...
                                            <div class="row">
                                              <div class="col-md-6">
                                                ...
                                                <input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror" id="basicInput" placeholder="Masukkan nama kategori">
                                                @error('judul')
                                              ...
                                              <div class="col-md-6">
                                                ...
                                                <input type="text" name="penulis" class="form-control @error('penulis') is-invalid @enderror" id="basicInput" placeholder="Masukkan nama kategori">
                                                @error('penulis')
                                                <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                              </div>
