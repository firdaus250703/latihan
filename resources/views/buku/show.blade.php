        ...
        <div id="main">
            <div>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Detail Buku : {{ $show->judul}}</li>
                </ol>
            </div>
            <header class="mb-3">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="row mt-5">
                                         <div class="col-md-5">
                                                <img class="w-75" src="{{ asset('upload'). "/" . $show->sampul }}" alt="">
                                         </div>
                                         <div class="col-md-7">
                                            <div class="table-responsive">
                                                <table class="table table-lg">
                                                        ...
                                                        <tr>
                                                            <th>tanggal</th>
                                                            <td>{{ $show->created_at->isoFormat('dddd, D MMMM Y') }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th>Deskripsi</th>
                                                            <td align="justify">{{ $show->deskripsi}}</td>
                                                        </tr>
                                                </table>
                                            </div>
                                         </div>
