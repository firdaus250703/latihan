                                                ...
                                                <table class="table table-lg">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="avatar avatar-md2">
                                                                    <img src="{{ asset('upload'). "/" . $item->sampul }}" alt="Sampul Buku">
                                                                </div>
                                                            </td>
                                                            <td class="text-bold-500">{{ $item->judul }}</td>
                                                            <td>{{ $item->penulis }}</td>
                                                            {{-- category itu dari models, dan kategory itu adalah nama field dari table kategori dan ini sudah direlasikan --}}
                                                            <td class="text-bold-500">{{ $item->category->kategori }}</td>

                                                            {{-- sintaks dibawah membatasi 100 huruf--}}
                                                            {{-- <td class="text-bold-500">{{ Str::limit($item->deskripsi, 100, '...') }}</td> --}}
                                                            {{-- sintaks dibawah membatasi kata yang lebih dari 20 kata --}}
                                                            <td class="text-bold-500">{{ Str::words($item->deskripsi, 20, '[...]') }}</td>

                                                            <td>
                                                                <a href="{{ route('buku.show', $item->id) }}" class="btn icon btn-primary"><i class="bi bi-info-circle"></i></a>
                                                                <a href="{{ route('buku.edit', $item->id) }}" class="btn icon btn-warning ms-3"><i class="bi bi-pencil"></i></a>
                                                                <form action="{{ route('buku.destroy', $item->id) }}" method="POST" class="d-inline">
                                                                    @method('DELETE')
                                                                    @csrf
                                                                    <button type="submit" onclick="return confirm('apakah mau dihapus?')" class="btn icon btn-danger ms-3"><i class="bi bi-trash"></i></button>
                                                                </form>
                                                            </td>
