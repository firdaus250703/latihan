                    ...
                    <div class="col-12 col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form action="{{ route('master.update',$kategori['id']) }}" method="POST">
                                            @method('PUT')
                                            @csrf
                                            <div class="form-group">
                                                <label for="basicInput">Nama kategori</label>
                                                <input type="text" value="{{$kategori['kategori']}}" name="nama_kategori" class="form-control @error('nama_kategori') is-invalid @enderror" id="basicInput" >
                                                @error('nama_kategori')
