                                        ...
                                        <div class="row">
                                            <div
                                                ...
                                                <div class="stats-icon purple mb-2">
                                                    <i class="iconly-boldShow" style="width: 5rem; margin-left:10px;"></i>
                                                </div>
                                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7 ms-5">
                                                    <h6 class="text-muted font-semibold">Jumlah Kategori</h6>
                                                    <h6 class="font-extrabold mb-0">{{ count($kategori) }}</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div
                                                ...
                                                <div class="stats-icon blue mb-2">
                                                    <i class="iconly-boldProfile" style="width: 5rem; margin-left:10px;"></i>
                                                </div>
                                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7 ms-5">
                                                    <h6 class="text-muted font-semibold">Jumlah buku</h6>
                                                    <h6 class="font-extrabold mb-0">{{ count($buku) }}</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div
                                                ...
                                                <div class="stats-icon green mb-2">
                                                    <i class="iconly-boldAdd-User" style="width: 5rem; margin-left:10px;"></i>
                                                </div>
                                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7 ms-5">
                                        ...
                                        <div class="row">
                                            <div
                                                ...
                                                <div class="stats-icon red mb-2">
                                                    <i class="iconly-boldBookmark" style="width: 5rem; margin-left:10px;"></i>
                                                </div>
                                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7 ms-5">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="text-secondary"><b>Data ...</b></h4>
                                    </div>
                                    <div class="card-body">
